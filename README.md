...
This git repository contains your practice assignments for the workshops and some additional exercises. It also includes a predefined `.gitignore`, `requirements.txt`, `LICENSE` and `citation.cff` for your convenience. Start this assignment by forking and cloning the repository so that you can work on it locally.
...
```
git remote add upstream git@github.com:CIEM5000-2026/practice-assignments.git
git fetch upstream
```
...
- Solutions [workshop 1](https://github.com/CIEM5000-2026/practice-assignments/tree/solution_workshop_1) with [changes](https://github.com/CIEM5000-2026/practice-assignments/compare/main...solution_workshop_1)
- Solutions [workshop 2](https://github.com/CIEM5000-2026/practice-assignments/tree/solution_workshop_2) with [changes](https://github.com/CIEM5000-2026/practice-assignments/compare/solution_workshop_1...solution_workshop_2)


## Additional exercises
If you'd like to practise more or if you're looking for a more difficult challenge, have a look at the additional exercises in `Additional_**`.  The full solutions are provided after the second workshop session in the form of updated notebook files `Additional_**.ipynb` and a correct implementation in `./matrixmethod/`: solutions [Additional_exercises](https://github.com/CIEM5000-2026/practice-assignments/tree/solution_additional_exercises) with [changes](https://github.com/CIEM5000-2026/practice-assignments/compare/solution_workshop_1...solution_additional_exercises).
